...
const handleDelete = (row) => {
  ...
  //删除仿真资源时, 需要弹出一个确认框, 如果是确认, 则删除仿真资源
...
const formRules = ref({
  ...
  url: [
    { required: true, message: '请输入仿真资源链接', trigger: 'blur' },
...
<template>
  ...
  <el-table :data="tableData" border style="width: 100%;">
    ...
    <el-table-column prop="name" label="仿真资源名称" width="300" align="center"/>
    <el-table-column prop="url" label="仿真资源链接" width="300" align="center"/>
  ...
  <el-dialog v-model="showDialog" :title="formTitle" width="30%" @close="resetForm">
    <el-form :model="deptForm" :rules="formRules" ref="deptFormRef">
      ...
      <el-form-item label="仿真资源链接" prop="url" label-width="120px">
        <el-input v-model="deptForm.url" autocomplete="off"></el-input>
      </el-form-item>
    </el-form>
